...
# 강한 제외 키워드 (IT/카메라/스펙/기기/금융/정책/속보/홍보)
BANNED_DISCOVERY_KEYWORDS = [
    "카메라", "렌즈", "미러리스", "dslr", "바디", "캐논", "소니", "니콘", "후지필름", "펜탁스", "탐론", "시그마",
    "출사", "개봉기", "언박싱", "스펙", "tech", "테크", "it", "이어폰", "헤드폰", "모니터", "그래픽카드", "충전기",
    "아이폰", "갤럭시", "스마트폰", "노트북", "gpu", "cpu", "조립pc", "태블릿", "아이패드", "맥북",
    "지원금", "정부정책", "주식", "코인", "비트코인", "증시", "속보", "사건", "환급금", "대출", "부동산 분양", "청약",
    "프로필 나이 학력", "보험", "카드사", "협찬사", "홍보대행", "리뷰어", "체험단 모집"
]
